...
export default class Slide1 extends Component {
  ...
  render() {
    return (
      ...
      <Image source = {require('../../images/childish.png')} resizeMode="contain" style={{flex:1, width:null, height:null}}>
      <Image source = {require('../../images/overlay2.png')} resizeMode="contain" style={{flex:1, width:null, height:null, }}>
      <View style={{flex:9, alignItems:'center', justifyContent:'center'}}>
      <Text style={{color:'#ff7007', fontWeight:'600', margin:3, letterSpacing: 3, fontSize:30}}>SLACKER</Text>
      <View>
      <Text style={{color:'#fff', fontSize:11, fontWeight:'600'}}>RADIO</Text>
      </View>
      <Text style={{color:'#fff', letterSpacing: 4, fontSize:19, margin:10, width:250, textAlign:'center', fontWeight:'400'}}>CHILDISH GAMBINO COLLECTION</Text>
      </View>
